...
public class PaymentValidationStepDefinition extends TestBase {
	...
	public void user_goes_to_Application_Support_Tools_and_click_on_Import_Export_menu() throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		driver.switchTo().frame("toc");
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		paymentFlow = homePage.importSwiftLink();
	}
	
	@Then("user import High value Inward Payment in application")
	public void user_import_High_value_Inward_Payment_in_application() throws InterruptedException {
		paymentFlow=paymentFlow.importSwiftMessage1();
	}
	
	@Then("user import High value Payment in application")
	public void user_import_High_value_Payment_in_application() throws InterruptedException {
		paymentFlow=paymentFlow.importSwiftMessage2();
	}
	
	@Then("user import MT message in application")
	public void user_import_MT_message_in_application() throws InterruptedException {
		paymentFlow=paymentFlow.importSwiftMessage3();
	}
